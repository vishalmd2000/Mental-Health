...
with open("rand_log_pkl", "br") as log,\
     open("rand_dt_pkl", "br") as dt,\
     open("rand_rf_pkl", "br") as rf,\
     open("rand_knn_pkl", "br") as knn,\
     open("rand_stack_pkl", "br") as stack,\
     open("rand_bag_pkl", "br") as bag,\
     open("rand_boost_pkl", "br") as boost:
    log = pickle.load(log)
    dt = pickle.load(dt)
    rf = pickle.load(rf)
    knn = pickle.load(knn)
